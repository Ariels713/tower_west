...
export const featuredProperties = [
  {
    ...
    location: "Apt. 15C",
    address:
      "Apartment Description. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim",
    size: "1400 Sq Ft",
    garages: 2,
    baths: 2,
    rooms: 3,
